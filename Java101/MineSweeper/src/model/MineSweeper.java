...
public class MineSweeper {
	...
	public void Yazdir(String[][] panel) {
		for (int i = 0; i < panel.length; i++) {
			for (int j = 0; j < panel[i].length; j++) {
	...
	public String[][] BombaPanel(String[][] bombapanel) {
	...
	public void OyunaBasla(String[][] panel, String[][] bombapanel) {
